...
const addData = (req, res) => {
    ...
    let dataToAdd = {
        ...
        rock: data.dicRolled.rock,
        wheat: data.dicRolled.wheat,
        sheep: data.dicRolled.sheep,
        brick: data.dicRolled.brick,
        wood: data.dicRolled.wood,
        gold: data.dicRolled.gold,
